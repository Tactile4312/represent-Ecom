...
class Order extends Model
{
    protected $fillable=[
        ...
        'last_name','country','post_code','address1','address2','phone','email','payment_method','payment_status',
        'shipping_id','coupon','gcash_receipt','cancel_reason', 'cancel_request_status','gcash_reference'
    ];
