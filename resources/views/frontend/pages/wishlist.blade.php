                ...
                <table class="table shopping-summery">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="add-to-cart-form-{{$wishlist->product['id']}}" action="{{ route('single-add-to-cart') }}" method="POST" style="display: none;">
                                    @csrf
                                    <input type="hidden" name="slug" value="{{ $wishlist->product['slug'] }}">
                                    <input type="hidden" name="quant[1]" value="1">
                                </form>
                                <a href="#" onclick="event.preventDefault(); document.getElementById('add-to-cart-form-{{$wishlist->product['id']}}').submit();" class='btn text-white'>Add To Cart</a>
                            </td>
